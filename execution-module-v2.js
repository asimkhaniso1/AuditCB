...
`;
    ...
    window.exportReportPDF = function () {
        ...
        const reportHtml = '<!DOCTYPE html><html><head>'
            ...
            // SECTION 9 - MEETINGS
            + (en['meetings'] !== false ? '<div id="sec-meetings" class="sh page-break" style="border-left-color:#0891b2;"><span class="sn">9</span>MEETING RECORDS</div><div class="sb">'
                + '<div style="padding:18px;background:#f0fdf4;border-radius:10px;margin-bottom:16px;"><strong style="color:#166534;font-size:0.95rem;">Opening Meeting</strong><table class="info-tbl" style="margin-top:10px;"><tr><td style="width:25%;">Date</td><td>' + (d.report.openingMeeting?.date || 'N/A') + '</td></tr><tr><td>Attendees</td><td>' + (function () { var att = d.report.openingMeeting?.attendees; if (!att) return 'N/A'; if (Array.isArray(att)) return att.map(function (a) { return typeof a === 'object' ? (a.name || '') + (a.role ? ' (' + a.role + ')' : '') : a; }).filter(Boolean).join(', ') || 'N/A'; return String(att); })() + '</td></tr>' + (editedOpeningNotes ? '<tr><td>Notes</td><td>' + editedOpeningNotes + '</td></tr>' : '') + '</table></div>'
                + '<div style="padding:18px;background:#eff6ff;border-radius:10px;"><strong style="color:#1e40af;font-size:0.95rem;">Closing Meeting</strong><table class="info-tbl" style="margin-top:10px;"><tr><td style="width:25%;">Date</td><td>' + (d.report.closingMeeting?.date || 'N/A') + '</td></tr><tr><td>Attendees</td><td>' + (function () { var att = d.report.closingMeeting?.attendees; if (!att) return 'N/A'; if (Array.isArray(att)) return att.map(function (a) { return typeof a === 'object' ? (a.name || '') + (a.role ? ' (' + a.role + ')' : '') : a; }).filter(Boolean).join(', ') || 'N/A'; return String(att); })() + '</td></tr><tr><td>Summary</td><td>' + (editedClosingSummary || 'N/A') + '</td></tr></table></div>'
                + '</div>' : '')
            // EVIDENCE GALLERY
            + (function () {
                var evidenceItems = [];
            ...
            // SECTION 7
            + (en['conclusion'] !== false ? '<div id="sec-conclusion" class="sh page-break" style="border-left-color:#4338ca;"><span class="sn">10</span>AUDIT CONCLUSION & RECOMMENDATION</div><div class="sb">'
