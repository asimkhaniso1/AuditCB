...
`;
    ...
    window.exportReportPDF = function () {
        ...
        const reportHtml = '<!DOCTYPE html><html><head>'
            ...
            + '@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact;padding-bottom:14mm;font-size:10pt;}.page-break{page-break-before:always;}.no-print{display:none !important;}.section-card,tr{break-inside:avoid;}.sh{-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;break-after:avoid;margin-top:12px;}.sb{break-before:avoid;}.watermark{display:block !important;}}'
            ...
            + '.watermark{display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index:0;pointer-events:none;overflow:hidden;}.watermark span{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-35deg);font-size:80pt;font-weight:900;color:rgba(148,163,184,0.07);letter-spacing:10px;white-space:nowrap;font-family:Outfit,sans-serif;}'
            + '</style></head><body>'
