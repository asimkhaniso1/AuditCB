...
`;
    ...
    window.exportReportPDF = function () {
        ...
        const reportHtml = '<!DOCTYPE html><html><head>'
            ...
            + '.rpt-hdr{display:none;position:fixed;top:0;left:0;right:0;height:16mm;background:linear-gradient(135deg,#1e3a5f,#2563eb);color:white;padding:3mm 12mm;align-items:center;justify-content:space-between;font-size:0.72rem;z-index:100;}'
            + '.rpt-hdr-left{display:flex;align-items:center;gap:8px;font-weight:700;font-size:0.82rem;}'
            + '.rpt-hdr-logo{height:22px;max-width:100px;object-fit:contain;border-radius:3px;}'
            + '.rpt-hdr-logo-fallback{width:24px;height:24px;background:rgba(255,255,255,0.2);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.65rem;}'
            + '.rpt-hdr-center{text-align:center;flex:1;font-size:0.68rem;opacity:0.85;letter-spacing:0.3px;text-transform:uppercase;}'
            + '.rpt-hdr-right{text-align:right;font-size:0.68rem;opacity:0.85;}'
            ...
            + '.sh{background:linear-gradient(135deg,#1e3a5f,#2563eb);color:white;padding:12px 20px;font-weight:700;font-size:0.95rem;letter-spacing:0.5px;display:flex;align-items:center;gap:10px;border-radius:6px 6px 0 0;margin-top:30px;}'
            ...
            + '.info-tbl{width:100%;border-collapse:collapse;}.info-tbl td{padding:8px 14px;border-bottom:1px solid #f1f5f9;font-size:0.88rem;}.info-tbl td:first-child{width:30%;color:#64748b;font-weight:600;}.info-tbl tr:nth-child(even){background:#f8fafc;}'
            ...
            + '.chart-title{font-size:0.8rem;font-weight:700;color:#334155;margin-bottom:10px;text-transform:uppercase;letter-spacing:0.3px;}'
