    ...
    window.exportReportPDF = function () {
        ...
        const reportHtml = '<!DOCTYPE html><html><head>'
            ...
            + (en['summary'] !== false ? '<div id="sec-summary" class="sh page-break" style="border-left-color:#059669;"><span class="sn">2</span>EXECUTIVE SUMMARY</div><div class="sb">'
                ...
                + (editedPositiveObs ? '<div class="callout" style="background:#f0fdf4;border-left:4px solid #22c55e;page-break-before:always;"><strong style="color:#166534;">Positive Observations</strong><div style="color:#15803d;margin-top:6px;">' + editedPositiveObs + '</div></div>' : '')
