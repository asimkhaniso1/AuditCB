...
`;
    ...
    window.exportReportPDF = function () {
        ...
        const reportHtml = '<!DOCTYPE html><html><head>'
            ...
            + '@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact;padding-bottom:14mm;font-size:10pt;}.page-break{page-break-before:always;}.no-print{display:none !important;}.section-card,tr{break-inside:avoid;}.sh{-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;break-after:avoid;margin-top:12px;}.sb{break-before:avoid;}body::after{content:"CONFIDENTIAL";position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-35deg);font-size:90pt;font-weight:900;color:rgba(148,163,184,0.08);letter-spacing:12px;pointer-events:none;z-index:0;white-space:nowrap;}.cover::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:white;z-index:1;}.cover>*{position:relative;z-index:2;}}'
